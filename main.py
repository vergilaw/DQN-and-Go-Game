...
def main():
    # Khởi tạo các biến bên ngoài để truy cập trong finally
    thread_pool = None
        ...
        def handle_bot_turn(bot, player):
            ...
            while attempts < max_attempts and time.time() - start_time < 10.0:
                try:
                    ...
                    if 'action' in locals() and action not in invalid_moves:
                        invalid_moves.append(action)
                    continue
        ...
        while running:
            ...
            if bot_vs_bot and game.show_score:
                ...
                if current_time - score_display_time >= 5:
                    ...
                    game.screen.blit(next_game_text, (WINDOW_SIZE // 2 - 100, WINDOW_SIZE - 30))
